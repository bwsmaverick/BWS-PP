...
// bwscoin: sync-checkpoint master key
...
// bwscoin: synchronized checkpoint (centrally broadcasted)
...
// bwscoin: get last synchronized checkpoint
...
// bwscoin: only descendant of current sync-checkpoint is allowed
...
// bwscoin: reset synchronized checkpoint to last hardened checkpoint
...
// bwscoin: find block wanted by given orphan block
...
// bwscoin: verify signature of sync-checkpoint message
...
// bwscoin: process synchronized checkpoint
...
// get information of sync-checkpoint (first introduced in bwscoin)
