...
void MultisigDialog::on_sendTransactionButton_clicked()
{
    ...
    ui->statusLabel->setText(tr("The transaction is sent to bitcoinwspectrum network."));
}
