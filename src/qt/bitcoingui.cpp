 ...
 * The Bitcoinwspectrum developers 2011-2018
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Bitcoinwspectrum") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/bitcoinwspectrum"));
    setWindowIcon(QIcon(":icons/bitcoinwspectrum"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitcoinwspectrum address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoinwspectrum"), tr("&About Bitcoinwspectrum"), this);
    aboutAction->setStatusTip(tr("Show information about Bitcoinwspectrum"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Bitcoinwspectrum"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bitcoinwspectrum"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitcoinwspectrum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitcoinwspectrum addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/bitcoinwspectrum"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://bitcoinwspectrum.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/bitcoinwspectrum"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.bitcoinwspectrum.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/bitcoinwspectrum_testnet"));
            setWindowIcon(QIcon(":icons/bitcoinwspectrum_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/bitcoinwspectrum_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Bitcoinwspectrum client"));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://bitcoinwspectrum.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.bitcoinwspectrum.net"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitcoinwspectrum network", "", count));
}
...
{
    QString strTitle = tr("Bitcoinwspectrum"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Bitcoinwspectrum address or malformed URI parameters."),
