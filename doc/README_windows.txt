...
Setup
-----
After completing windows setup then run bitcoinwspectrum-qt.
Alternatively you can run windows command line (cmd) in bitcoinwspectrum program dir.
  cd daemon
  bitcoinwspectrumd
You would need to create a configuration file bitcoinwspectrum.conf in the default
wallet directory. Grant access to bitcoinwspectrumd/bitcoinwspectrum-qt in anti-virus and firewall
