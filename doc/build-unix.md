...
UNIX BUILD NOTES FOR BITCOINWSPECTRUM
====================
...
This will build Bitcoinwspectrum-Qt as well if the dependencies are met.
...
Note: Currently, there is no bitcoinwspectrum ebuild available in overlay 
...
Take the following steps to build (no UPnP support):
	...
	cd ${BITCOINWSPECTRUM_DIR}
	./autogen.sh
	./configure --without-miniupnpc CXXFLAGS="-i/usr/include/db4.8"
	strip src/bitcoinwspectrumd


Notes
-----
The release is built with GCC and then "strip bitcoinwspectrumd" to strip the debug
